...
const capabilities = [
  ...
  },
  {
    ...
    desc: 'Paneles internos, portales de clientes y productos SaaS.',
  },
  {
    ref: 'S—03',
    title: 'Apps móviles',
    desc: 'iOS y Android desde una sola base de código.',
  },
  {
    ref: 'S—04',
    title: 'Integraciones & APIs',
    desc: 'Pagos, CRMs, ERPs y servicios externos hablando entre sí.',
  },
  {
    ref: 'S—05',
    title: 'Cloud & infraestructura',
    desc: 'Despliegues confiables, con monitoreo y costos bajo control.',
  },
  {
    ref: 'S—06',
...
const phases = [
  ...
  },
  {
    n: '02',
    title: 'Diseño',
    desc: 'Prototipamos y validamos la solución antes de escribir el código crítico.',
  },
  {
    n: '03',
    title: 'Construcción',
  ...
  },
  {
    n: '04',
    title: 'Lanzamiento',
    desc: 'Salimos a producción, medimos resultados e iteramos según datos.',
  },
]
...
const principles = [
  {
    k: 'A',
    title: 'Hablamos de negocio, no solo de código',
    desc: 'Cada decisión técnica responde a un objetivo tuyo: vender más, ahorrar tiempo o reducir errores.',
  },
  {
    k: 'B',
  ...
  {
    k: 'C',
    title: 'Código que no te encadena',
    desc: 'Tecnología estándar y documentada. El producto es tuyo y cualquier equipo puede continuarlo.',
  },
  {
    k: 'D',
...
const stack = ['React', 'TypeScript', 'Node.js', 'Python', 'React Native', 'PostgreSQL', 'AWS', 'Docker']
  ...
  return (
    <div className="min-h-screen">
      ...
      <header className="sticky top-0 z-50 border-b bp-rule backdrop-blur-md" style={{ background: 'color-mix(in srgb, var(--bp-bg) 82%, transparent)' }}>
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          ...
          <nav className="hidden items-center gap-8 font-mono text-xs uppercase tracking-widest md:flex bp-muted">
            <a href="#capacidades" className="hover-accent">Capacidades</a>
            <a href="#proceso" className="hover-accent">Proceso</a>
            <a href="#metodo" className="hover-accent">Método</a>
          </nav>
          <a
            href={whatsappUrl}
            target="_blank"
      ...
      <main className="mx-auto max-w-6xl px-5">
        ...
        <section id="inicio" className="grid items-center gap-12 py-16 sm:py-24 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rise">
            ...
            <p className="mt-7 max-w-md text-lg leading-relaxed bp-muted">
              En Lantix diseñamos y desarrollamos las aplicaciones web, móviles
              e integraciones que tu empresa necesita. Cada pieza, medida y
              ajustada a tu operación.
            </p>
            ...
            <p className="mt-6 font-mono text-xs bp-muted">
              [ DISPONIBLES · RESPUESTA &lt; 24H · PRIMERA REUNIÓN SIN COSTO ]
            </p>
          </div>
            ...
            <div className="corner-ticks plate relative aspect-[4/3] w-full">
              ...
              <div className="flex h-full w-full items-center justify-center p-6 pb-14">
                <img
                  ...
                  className="h-full w-auto object-contain drop-shadow-[0_0_30px_rgba(34,211,238,0.22)]"
                />
              </div>
        ...
        <section id="capacidades" className="pt-28 pb-16 sm:pt-40 sm:pb-24">
        ...
        <section id="proceso" className="py-16 sm:py-24">
          ...
          <div className="grid gap-px overflow-hidden border bp-rule sm:grid-cols-2 lg:grid-cols-4" style={{ background: 'var(--bp-rule)' }}>
            {phases.map((p) => (
              <div key={p.n} className="relative p-7" style={{ background: 'var(--bp-bg)' }}>
        ...
        <section id="metodo" className="py-16 sm:py-24">
          <SectionTag id="03" label="Método / principios de trabajo" />
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
            <div>
              <h2 className="font-display text-3xl font-semibold leading-tight sm:text-4xl">
                Un socio de ingeniería, no un proveedor más.
              </h2>
              ...
              <div className="mt-8 plate corner-ticks relative p-5">
                <p className="font-mono text-xs uppercase tracking-widest bp-muted">Stack de referencia</p>
                <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2 font-mono text-sm">
                  {stack.map((t) => (
                    <span key={t} className="bp-muted">{t}</span>
                  ))}
                </div>
              </div>
            </div>
            ...
            <ul className="grid gap-px border bp-rule sm:grid-cols-2" style={{ background: 'var(--bp-rule)' }}>
              {principles.map((pr) => (
                <li key={pr.k} className="p-7" style={{ background: 'var(--bp-bg)' }}>
      ...
      <footer className="border-t bp-rule">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-5 py-8 sm:flex-row">
          <Logo className="h-12 w-auto" />
          <p className="font-mono text-xs bp-muted">
